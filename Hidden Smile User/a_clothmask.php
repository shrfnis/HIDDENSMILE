...
$sql="SELECT * FROM items WHERE item_Type = 'Cloth Mask' AND loop_Type = 'Earloop' AND categories = 'Adults'";
...
<head>
    ...
    <!-- Title  -->
    <title>Hidden Smile | Adults Cloth Face Mask</title>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <div class="cart-fav-search mb-100">
                ...
                <!-- <a href="#" class="fav-nav"><img src="img/core-img/<h2>s.png" alt=""> Favourite</a>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mt-50">
                                ...
                                <li class="breadcrumb-item"><a href="facemask.php">Shop</a></li>
                                <li class="breadcrumb-item"><a href="#">Adults Cloth Face Mask</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <div class="single_product_thumb ">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators flex-wrap max-1">
                                    <?php
                                    $sql2="SELECT * FROM items WHERE item_Type = 'Cloth Mask' AND loop_Type = 'Earloop' AND categories = 'Adults'";
                                    ...
                                    {?>
                                    <li class="<?php echo $active ?> mb-3" data-target="#product_details_slider" data-slide-to="<?php echo $dslide ?>" style="background-image: url(img/hs-img/<?php echo $row_rs2['item_Img']; ?>);">
                                    </li>
                                    <?php
                                    $active = '';
                                    $dslide ++;
                                ...
                                <?php
                                    $sql3="SELECT * FROM items WHERE item_Type = 'Cloth Mask' AND loop_Type = 'Earloop' AND categories = 'Adults'";
                                    $rs3 = mysqli_query($dbconn, $sql3);
                                    $active= 'active';
                                    $dslide = 1;
                                    while($row_rs3 = mysqli_fetch_assoc($rs3))
                                    {?>
                                    <div class="carousel-item mb-3 <?php echo $active ?>">
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                <div class="line"></div>
                                <p class="product-price">From RM15</p>
                                <a href="product-details.php">
                                    <h6>Adults Cloth Face Mask</h6>
                                </a>
                                <!-- Ratings & Review -->
                            ...
                            <div class="custom-control custom-radio custom-control-inline"  >
                                    ...
                                    id="design<?php echo $dcounter ?>" name="itemname" value="<?php echo $row_rs['item_Name']; ?>" >
                                    <label class="custom-control-label" for="design<?php echo $dcounter ?>">
                                        <?php echo $row_rs['item_Name']; ?>
                                    </label>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <div class="custom-control custom-radio custom-control-inline">
                                    ...
                                    <label class="custom-control-label" for="type-1">Earloop RM(15)</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="type-2" name="looptype" value="Headloop">
                                    <label class="custom-control-label" for="type-2">Headloop RM(19)</label>
                                </div>
                            </div>
                        </div>
...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <div class="cart-fav-search mb-100">
                <a href="cart.php?id=<?php echo $guest ?>" class="cart-nav"><img src="img/core-img/cart.png" alt=""> Cart <span>(<?php echo $row_rs2['total_Item'] ?>)</span></a>
                <!--<a href="#" class="fav-nav"><img src="img/core-img/<h2>s.png" alt=""> Favourite</a>
                 <a href="#" class="search-nav"><img src="img/core-img/search.png" alt=""> Search</a> -->
            </div>
            <!-- Button Group -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mt-50">
                                <li class="breadcrumb-item"><a href="../index.php?id=<?php echo $guest ?>">Home</a></li>
                                <li class="breadcrumb-item"><a href="facemask.php?id=<?php echo $guest ?>">Shop</a></li>
                                <li class="breadcrumb-item"><a href="#">Adults Cloth Face Mask</a></li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="row max-0">
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <form id="cartForm"  name="cartForm" method="POST" action="addcart0.php?id=<?php echo $guest ?>">
                                <div class="custom-control custom-radio custom-control-inline" >
