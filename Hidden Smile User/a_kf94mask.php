...
$sql="SELECT * FROM items WHERE item_Type = 'KF94 Face Mask' AND loop_Type = 'Earloop' AND categories = 'Adults'";
...
<head>
    ...
    <!-- Title  -->
    <title>Hidden Smile | Adults KF94 Face Mask</title>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mt-50">
                                ...
                                <li class="breadcrumb-item"><a href="#">Adults KF94 Face Mask</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row max-0">
                    <div class="col">
                        <div class="single_product_thumb">
                            ...
                            <?php
                                    $sql2="SELECT * FROM items WHERE item_Type = 'KF94 Face Mask' AND loop_Type = 'Earloop' AND categories = 'Adults'";
                                ...
                                <?php
                                    $sql3="SELECT * FROM items WHERE item_Type = 'KF94 Face Mask' AND loop_Type = 'Earloop' AND categories = 'Adults'";
                        ...
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                ...
                                <a href="product-details.php">
                                    <h6>Adults KF94 Face Mask (50pcs)</h6>
                                </a>
                                <!-- Ratings & Review -->
