...
$sql="SELECT * FROM items WHERE item_Type = 'Disposable Face Mask' AND loop_Type = 'Earloop' AND categories = 'Kids'";
...
<head>
    ...
    <!-- Title  -->
    <title>Hidden Smile | Kids Disposable Face Mask</title>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mt-50">
                                ...
                                <li class="breadcrumb-item"><a href="#">Kids Disposable Face Mask</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                ...
                                <?php
                                    $sql2="SELECT * FROM items WHERE item_Type = 'Disposable Face Mask' AND loop_Type = 'Earloop' AND categories = 'Kids'";
                                ...
                                <?php
                                    $sql3="SELECT * FROM items WHERE item_Type = 'Disposable Face Mask' AND loop_Type = 'Earloop' AND categories = 'Kids'";
                        ...
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                ...
                                <a href="product-details.php">
                                    <h6>Kids Disposable Face Mask (50pcs)</h6>
                                </a>
                                <!-- Ratings & Review -->
