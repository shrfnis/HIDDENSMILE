                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                <a href="a_clothmask.php">
                                <img src="img/hs-img/a1.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="a_clothmaskfilter.php">
                                <img src="img/hs-img/a2.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="a_tshirtmask.php">
                                <img src="img/hs-img/a3.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="a_disposablemask.php">
                                <img src="img/hs-img/a4.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="a_kf94mask.php">
                                <img src="img/hs-img/a5.jpg" alt="">
                            </div>
        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                <ul>
                    ...
                    <li class="active"><a href="facemask.php?id=<?php echo $guest ?>">Shop</a></li>
                </ul>
            </nav>
            <!-- Cart Menu -->
            <?php
            ...
            ?>
            <div class="cart-fav-search mb-100">
                <a href="cart.php?id=<?php echo $guest ?>" class="cart-nav"><img src="img/core-img/cart.png" alt=""> Cart <span>(<?php echo $row_rs1['total_Item'] ?>)</span></a>
                <!--<a href="#" class="search-nav"><img src="img/core-img/search.png" alt=""> Search</a> -->
            </div>
            <!-- Button Group -->
            <div class="amado-btn-group mt-30 mb-100 list">
        ...
        <div class="shop_sidebar_area">
            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        <li class="active"><a href="#">Adults</a></li>
                        <li><a href="kids.php?id=<?php echo $guest ?>">Kids</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="a_clothmask.php?id=<?php echo $guest ?>">
                                <img src="img/hs-img/a1.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="a_clothmaskfilter.php?id=<?php echo $guest ?>">
                                <img src="img/hs-img/a2.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="a_tshirtmask.php?id=<?php echo $guest ?>">
                                <img src="img/hs-img/a3.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="a_disposablemask.php?id=<?php echo $guest ?>">
                                <img src="img/hs-img/a4.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="a_kf94mask.php?id=<?php echo $guest ?>">
                                <img src="img/hs-img/a5.jpg" alt="">
                            </div>
