...
$sql="SELECT * FROM items WHERE item_Type = 'Disposable Face Mask' AND loop_Type = 'Earloop' AND categories = 'Adults'";
...
<head>
    ...
    <!-- Title  -->
    <title>Hidden Smile | Adults Disposable Face Mask</title>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mt-50">
                                ...
                                <li class="breadcrumb-item"><a href="#">Adults Disposable Face Mask</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                ...
                                <?php
                                    $sql2="SELECT * FROM items WHERE item_Type = 'Disposable Face Mask' AND loop_Type = 'Earloop' AND categories = 'Adults'";
                                ...
                                <?php
                                    $sql3="SELECT * FROM items WHERE item_Type = 'Disposable Face Mask' AND loop_Type = 'Earloop' AND categories = 'Adults'";
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                <div class="line"></div>
                                <p class="product-price">From RM25</p>
                                <a href="product-details.php">
                                    <h6>Adults Disposable Face Mask (50pcs)</h6>
                                </a>
                                <!-- Ratings & Review -->
                        ...
                        <div class="mb-4">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <div class="custom-control custom-radio custom-control-inline">
                                    ...
                                    <label class="custom-control-label" for="type-1">Earloop RM(25)</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="type-2" name="looptype" value="Headloop">
                                    <label class="custom-control-label" for="type-2">Headloop RM(29)</label>
                                </div>
                            </div>
                        </div>
