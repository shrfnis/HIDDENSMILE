...
$sql="SELECT * FROM items WHERE item_Type = 'Cloth Mask' AND loop_Type = 'Earloop' AND categories = 'Kids'";
...
<head>
    ...
    <!-- Title  -->
    <title>Hidden Smile | Kids Cloth Face Mask</title>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mt-50">  
                                ...
                                <li class="breadcrumb-item"><a href="#">Kids Cloth Face Mask</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                ...
                                <?php
                                    $sql2="SELECT * FROM items WHERE item_Type = 'Cloth Mask' AND loop_Type = 'Earloop' AND categories = 'Kids'";
                                ...
                                <?php
                                    $sql3="SELECT * FROM items WHERE item_Type = 'Cloth Mask' AND loop_Type = 'Earloop' AND categories = 'Kids'";
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                <div class="line"></div>
                                <p class="product-price">From RM12</p>
                                <a href="product-details.php">
                                    <h6>Kids Cloth Face Mask</h6>
                                </a>
                                <!-- Ratings & Review -->
                        ...
                        <div class="mb-4">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <div class="custom-control custom-radio custom-control-inline">
                                    ...
                                    <label class="custom-control-label" for="type-1">Earloop RM(12)</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="type-2" name="looptype" value="Headloop">
                                    <label class="custom-control-label" for="type-2">Headloop RM(16)</label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mt-50">  
                                ...
                                <li class="breadcrumb-item"><a href="kids.php?id=<?php echo $guest ?>">Shop</a></li>
                                <li class="breadcrumb-item"><a href="#">Kids Cloth Face Mask</a></li>
                            </ol>
                        </nav>
                    </div>
