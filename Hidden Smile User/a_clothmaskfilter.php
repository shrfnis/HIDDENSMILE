...
$sql="SELECT * FROM items WHERE item_Type = 'Cloth Mask With Filter' AND loop_Type = 'Earloop' AND categories = 'Adults'";
...
<head>
    ...
    <!-- Title  -->
    <title>Hidden Smile | Adults Cloth Mask With Filter</title>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mt-50">
                                ...
                                <li class="breadcrumb-item"><a href="#">Adults Cloth Face Mask with Filter</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                ...
                                <?php
                                    $sql2="SELECT * FROM items WHERE item_Type = 'Cloth Mask With Filter' AND loop_Type = 'Earloop' AND categories = 'Adults'";
                                ...
                                <?php
                                    $sql3="SELECT * FROM items WHERE item_Type = 'Cloth Mask With Filter' AND loop_Type = 'Earloop' AND categories = 'Adults'";
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                <div class="line"></div>
                                <p class="product-price">FROM RM20</p>
                                <a href="product-details.php">
                                    <h6>Adults Cloth Face Mask with Filter</h6>
                                </a>
                                <!-- Ratings & Review -->
                    ...
                    <form id="cartForm" name="cartForm" method="POST" action="addcart0.php">
                        ...
                        <div class=" mb-4">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="type-1" name="looptype" value="Earloop" onClick="selectPayment()">
                                    <label class="custom-control-label" for="type-1">Earloop (RM20)</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="type-2" name="looptype" value="Headloop" onClick="selectPayment()">
                                    <label class="custom-control-label" for="type-2">Headloop (RM24)</label>
                                </div>
                            </div>
...
<head>
    ...
    <!-- Title  -->
    <title>Hidden Smile | Adults Cloth Face Mask With Filter</title>
