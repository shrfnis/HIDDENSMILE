    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                <ul>
                    ...
                    <li class="active"><a href="facemask.php">Shop</a></li>
                </ul>
            </nav>
            <!-- Cart Menu -->
            <?php
        ...
        <div class="shop_sidebar_area">
            ...
            <div class="widget catagory mb-50">
                <!-- Widget Title -->
                <h6 class="widget-title mb-30">Catagories</h4>

                <!--  Catagories  -->
                <div class="catagories-menu">
                    <ul>
                        <li><a href="facemask.php">Adults</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                <a href="k_clothmask.php">
                                <img src="img/hs-img/k1.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="k_clothmaskfilter.php">
                                <img src="img/hs-img/k2.jpg" alt="">
                            </div>
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    <div class="line"></div>
                                    <a href="k_clothmaskfilter.php">
                                        <h4>Cloth Face Mask with Filter</h4>
                                    </a>
                                </div>
                                <!-- Ratings & Cart -->
                                <div class="ratings-cart text-right">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="k_tshirtmask.php">
                                <img src="img/hs-img/k3.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="k_disposablemask.php">
                                <img src="img/hs-img/k4.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="k_kf94mask.php">
                                <img src="img/hs-img/k5.jpg" alt="">
                            </div>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="shop_sidebar_area">
            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        <li><a href="facemask.php?id=<?php echo $guest ?>">Adults</a></li>
                        <li class="active"><a href="#">Kids</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="k_clothmask.php?id=<?php echo $guest ?>">
                                <img src="img/hs-img/k1.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="k_clothmaskfilter.php?id=<?php echo $guest ?>">
                                <img src="img/hs-img/k2.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="k_tshirtmask.php?id=<?php echo $guest ?>">
                                <img src="img/hs-img/k3.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="k_disposablemask.php?id=<?php echo $guest ?>">
                                <img src="img/hs-img/k4.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="k_kf94mask.php?id=<?php echo $guest ?>">
                                <img src="img/hs-img/k5.jpg" alt="">
                            </div>
