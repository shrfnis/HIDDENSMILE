...
$sql="SELECT * FROM items WHERE item_Type = 'T-shirt Face Mask' AND loop_Type = 'Earloop' AND categories = 'Adults'";
...
<head>
    ...
    <!-- Title  -->
    <title>Hidden Smile | Adults T-shirt Face Mask</title>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mt-50">
                                ...
                                <li class="breadcrumb-item"><a href="#">Adults T-shirt Face Mask</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(img/hs-img/c1.png);">
                                    </li>
                                </ol>
                                <div class="carousel-inner w-70">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="img/hs-img/c1.png">
                                            <img class="d-block w-100" src="img/hs-img/c1.png" alt="First slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                ...
                                <a href="product-details.php">
                                    <h6>Adults T-shirt Face Mask</h6>
                                </a>
                                <!-- Ratings & Review -->
...
<head>
    ...
    <!-- Title  -->
    <title>Hidden Smile | Adults T-shirt Cloth Face Mask</title>
                    ...
                    <div class="col">
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                <?php
                                    $sql2="SELECT * FROM items WHERE item_Type = 'T-shirt Face Mask' AND loop_Type = 'Earloop' AND categories = 'Adults'";
                                    $rs2 = mysqli_query($dbconn, $sql2);
                                    $active= 'active';
                                    $dslide = 0;
                                    $dcounter = 1;
                                ...
                                <div class="carousel-inner w-70">
                                <?php
                                    $sql3="SELECT * FROM items WHERE item_Type = 'T-shirt Face Mask' AND loop_Type = 'Earloop' AND categories = 'Adults'";
