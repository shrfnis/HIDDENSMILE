                  ...
                  <form action="" method="post">
                    <table class="table table-striped">
                      ...
                      <?php
                        ...
                        $total_pages_sql = "SELECT COUNT(*) FROM items WHERE categories = 'Kids'";
                        ...
                        $sql="SELECT * FROM items WHERE categories = 'Kids' ORDER BY item_Type LIMIT $start_from,$per_page_record";
