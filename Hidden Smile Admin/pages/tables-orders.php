  ...
  * Copyright ThemeSelection (https://themeselection.com)
  ...
  >
    <head>
      ...
      function del(oid){
        var cof=confirm("Are you sure you want to DELETE order "+ oid +"?");
        if(cof==true){
          window.location ='../php/delOrder0.php?oid=' + oid;
        }
      }
  
      function acc(uid){
        var cof=confirm("Are you sure you want to REACTIVATE "+ uid +"?");
        if(cof==true){
      ...
      <script type="text/javascript">
      function view(oid){ 
          window.location ='../pages/view-order-details.php?oid=' + oid;
      }
      </script>
    </head>
            ...
            <div class="content-wrapper">
              ...
              <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="d-flex justify-content-between">
                  <h5 class="card-header justify-content-start">Orders</h5>
                  ...
                  <form action="" method="post">
                    <table class="table table-striped">
                      ...
                      <?php
                        ...
                        $sql="SELECT o.order_ID, o.order_Date, o.payment_Status, o.order_Status, o.admin_ID, c.cust_ID, c.cust_Email, c.cust_PhoneNo FROM orders o JOIN customers c ON c.cust_ID = o.cust_ID LIMIT $start_from,$per_page_record";
                        ...
                        <tr>
                          ...
                          <td> <strong><?php echo $row_rs['order_ID']; ?></strong></td>
                          <td><?php echo $row_rs['cust_ID']; ?></td>
                          <td>
                          <?php echo $row_rs['cust_Email']; ?>
                          </td>
                          <td><?php echo $row_rs['cust_PhoneNo']; ?></td>
                          <?php if($row_rs['order_Status'] == 
                          'Processing'){ ?>
                          <td>
                          <span class="badge rounded-pill bg-warning">Processing</span>
                          </td>
                        <?php }
                        else if($row_rs['order_Status'] == 'Completed') { ?>
                          <td>
                    ...
                    <?php } ?>
                          <?php if($row_rs['payment_Status'] == 'Unpaid'){ ?>
                          <td>
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a type="button" class="dropdown-item" href="javascript:void(0);" onClick="view('<?php echo $row_rs['order_ID'];?>')"
                                  ><i class="bx bx-show me-1"></i> View</a>
                                  <a type="button" class="dropdown-item" href="javascript:void(0);" onClick="del('<?php echo $row_rs['order_ID'];?>')"><i class="bx bx-trash me-1" ></i>Delete</a>
                              </div>
                            </div>
                          </td>
                        </tr>
