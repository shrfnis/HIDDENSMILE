                ...
                <div class="row">
                  ...
                  <div class="d-flex justify-content-between">
                    ...
                    <div class="card mb-4">
                      ...
                      <div class="card-body">
                      <?php
                          $sql="SELECT * FROM customers WHERE cust_ID ="."'".$_GET['uid']."'";
                      ...
                      <div class="card-body">
                        <form id="formAccountSettings" action="">
                          <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                              <label for="firstName" class="form-label">Adress :</label>
                              <?php
                              if($row_rs['addr1'] != ""){ ?>
                              <br>
                      ...
                      <div class="card-body">
                        <div class="mb-3 col-12 mb-0">
                          <div class="alert alert-warning">
                            <h6 class="alert-heading fw-bold mb-1">Are you sure you want to deactivate this account?</h6>
                            <!--<p class="mb-0">Once you delete this account, there is no going back. Please be certain.</p>-->
                          </div>
                        </div>
                        <form method="post" name="deactivation" action="">
                          ...
                          <button type="button" class="btn btn-danger deactivate-account" onClick="deactivateacc('<?php echo $row_rs['cust_ID']; ?>')">Deactivate Account</button>
                        </form>
                      </div>
                    </div> <?php } 
                    else {?>
                    <div class="card">
                        ...
                        <div class="card-body">
                          <div class="mb-3 col-12 mb-0">
                            <div class="alert alert-warning">
                              <h6 class="alert-heading fw-bold mb-1">Are you sure you want to Activate this account?</h6>
                              <!--<p class="mb-0">Once you delete this account, there is no going back. Please be certain.</p>-->
                            </div>
                          </div>
                          <form method="post" name="activation" action="">
                            <div class="form-check mb-3">
                              <input
                                class="form-check-input"
                                type="checkbox"
                              ...
                              <label class="form-check-label" for="activate"
                                >I confirm this account Activation</label
                              >
                            </div>
                            <button type="button" class="btn btn-success activate-account" onClick="activateacc('<?php echo $row_rs['cust_ID']; ?>')">Activate Account</button>
                            </div>
                          </form>
                        </div>
                    </div>
