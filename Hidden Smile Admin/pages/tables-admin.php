...
>
  <head>
    ...
    <title>Tables - Admins Tables</title>
    ...
    function edit(aid){ 
        window.location ='../pages/view-admin-details.php?aid=' + aid;
    }
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <li class="menu-item active">
                  ...
                  <li class="menu-item">
                  <a href="tables-adult-headloop.php" class="menu-link">
                    <div data-i18n="Adults">Headloop</div>
                  </a>
                  </li>
                  <li class="menu-item">
                  <a href="tables-adult-earloop.php" class="menu-link">
                ...
                <li class="menu-item active">
                  ...
                  <ul class="menu-sub">
                  <li class="menu-item">
                  <a href="tables-kid-all.php" class="menu-link">
                    <div data-i18n="Adults">All</div>
                  </a>
                  </li>
                  <li class="menu-item">
                  <a href="tables-kid-headloop.php" class="menu-link">
                    <div data-i18n="Adults">Headloop</div>
                  </a>
                  </li>
                  <li class="menu-item">
                  <a href="tables-kid-earloop.php" class="menu-link">
                    <div data-i18n="Adults">Earloop</div>
                  </a>
                  </li>
                  </ul>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="d-flex justify-content-between">
                <h5 class="card-header justify-content-start">Admins Accounts</h5>
                ...
                <form action="" method="post">
                  <table class="table table-striped">
                    ...
                    <?php
                      ...
                      $sql="SELECT* FROM admins LIMIT $start_from,$per_page_record";
                      $rs = mysqli_query($dbconn, $sql);
                      while($row_rs=mysqli_fetch_assoc($rs))
                      {
                      if($admin != $row_rs['admin_ID']) {?>
                      <tr>
                        <td>
                        <strong><?php echo $_GET['count']++ ?>.</strong></td>
                        </td>
                        <td> <strong><?php echo $row_rs['admin_ID']; ?></strong></td>
                        <td><?php echo $row_rs['admin_Name']; ?></td>
                        <td>
                        <?php echo $row_rs['admin_Email']; ?>
                        </td>
                        <td><?php echo $row_rs['admin_PhoneNo']; ?></td>
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a type="button" class="dropdown-item" href="javascript:void(0);" onClick="edit('<?php echo $row_rs['admin_ID'];?>')"
                                ><i class="bx bx-edit me-1"></i> Edit</a>
                                <a type="button" class="dropdown-item" href="javascript:void(0);" onClick="del('<?php echo $row_rs['admin_ID'];?>')"
