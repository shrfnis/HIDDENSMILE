  ...
  * Copyright ThemeSelection (https://themeselection.com)
  ...
  >
    <head>
      ...
      <title>Tables - Adults Earloop</title>
                  ...
                  <form action="" method="post">
                    <table class="table table-striped">
                      ...
                      <?php
                        ...
                        $total_pages_sql = "SELECT COUNT(*) FROM items WHERE categories = 'Adults' AND loop_Type = 'Earloop'";
                        ...
                        $sql="SELECT * FROM items WHERE categories = 'Adults' AND loop_Type = 'Earloop' ORDER BY item_ID LIMIT $start_from,$per_page_record";
