...
>
  <head>
    ...
    function del(aid){
      var cof=confirm("Are you sure you want to DELETE " + aid + "?");
      if(cof==true){
  ...
  <body>
              ...
              <div class="row">
                ...
                <div class="d-flex justify-content-between">
                  ...
                  <div class="card mb-4">
                    ...
                    <!-- Account -->
                    <div class="card-body">
                    <form action="..\php\updateAdmin0.php" method="POST" id="formupdateadmin" name="formupdateadmin" enctype="multipart/form-data">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img
                          src="../assets/img/avatars/<?php echo $_SESSION['admindp']; ?>"
                          name="admindp"
                          alt="user-avatar"
                    ...
                    <div class="card-body">
                        <div class="row">
                          <div class="mb-3 col-md-6">
                            ...
                            <input
                              ...
                              id="admin"
                              name="admin"
                              readonly value="<?php echo $_SESSION['admin']; ?>"
                              autofocus
                            />
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="lastName" class="form-label">Name</label>
                            <input class="form-control" type="text" name="name" id="lastName" value="<?php echo $_SESSION['name']; ?>" />
                          </div>
                          <div class="mb-3 col-md-6">
                        ...
                        <label class="form-label" for="opassword">Current Password</label>
                      ...
                      <div class="form-password-toggle mb-5 col-md-6">
                        ...
                        <div class="mt-2">
                          <button type="submit" class="btn btn-primary me-2" name="editprofile" onclick="return valid()">Save changes</button>
    ...
    <script>
        ...
        function valid(){
          var change = document.formupdateadmin.changepw.checked;
          var name = document.formupdateadmin.name.value;
          var email = document.formupdateadmin.email.value;
          var phoneno = document.formupdateadmin.phoneno.value;
          var newpw = document.formupdateadmin.npassword.value;
          var oldpw = document.formupdateadmin.opassword.value;
              ...
              <div class="row">
                ...
                <div class="d-flex justify-content-between">
                  ...
                  <div class="card mb-4">
                    ...
                    <!-- Account -->
                    <div class="card-body">
                    <form id="formupdateadmin" name="formupdateadmin" action="..\php\updateAdmin0.php" method="POST" enctype="multipart/form-data">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img
                          src="../assets/img/avatars/<?php echo $_SESSION['admindp']; ?>"
                          name="admindp"
