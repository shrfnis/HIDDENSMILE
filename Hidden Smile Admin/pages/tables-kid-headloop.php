...
>
  <head>
    ...
    <title>Tables - Kids Headloop</title>
                ...
                <form action="" method="post">
                  <table class="table table-striped">
                    ...
                    <?php
                      ...
                      $total_pages_sql = "SELECT COUNT(*) FROM items WHERE categories = 'Kids' AND loop_Type = 'Headloop'";
                      ...
                      $sql="SELECT * FROM items WHERE categories = 'Kids' AND loop_Type = 'Headloop' ORDER BY item_ID LIMIT $start_from,$per_page_record";
