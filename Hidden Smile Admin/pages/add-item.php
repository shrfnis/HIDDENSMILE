  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Item /</span> Add Item</h4>
                ...
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <?php
                        $total_rows = "SELECT COUNT(*) FROM items";
                        $result = mysqli_query($dbconn,$total_rows);
                        $new_id = (mysqli_fetch_array($result)[0]) + 1;
                        ?>

                      <form id="formAddItem" name="formAddItem" method="POST" action="..\php\addItem0.php" enctype="multipart/form-data">

                      <div class="d-flex align-items-start align-items-sm-center gap-4 mb-4">
                        <img
                          src="../../Hidden Smile User/img/hs-img/additem.png"
                          name="itemimgnull"
                          alt="user-avatar"
                    ...
                    <hr class="my-0 mb-4" />                  
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" name="itemtype" id="itemtype" placeholder="Cloth, Disposable, KF94 Face Mask etc." />
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="looptype" class="form-label">Loop Type</label>
                            <select class="form-select" id="looptype" name="looptype">
                            <option>Select Looptype</option>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input
                              ...
                              id="itemname"
                              name="itemname"
                              placeholder="Face Mask Color/Special Name"
                            />
                          </div>
                          <div class="mb-3 col-md-6">
                        ...
                        <div class="mt-2">
                          <button type="submit" class="btn btn-primary me-2" name="additem" onclick="return verify()">Save changes</button>
    ...
    <script>
       ...
       function verify(){
        ...
        var img = document.formAddItem.itemimg.value;
        var itemid = document.formAddItem.itemid.value;
        var itemtype =document.formAddItem.itemtype.value;
        var looptype =document.formAddItem.looptype.value;
        var qty = document.formAddItem.itemqty.value;
        var retail = document.formAddItem.retail.value;
        var sell = document.formAddItem.sell.value;
        var itemname =document.formAddItem.itemname.value;
        var categories =document.formAddItem.categories.value;
