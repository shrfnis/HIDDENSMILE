...
>
  <head>
    ...
    <title>Shipping Fee - Setting</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Shipping Fee Settings /</span> Shipping Fee</h4>

              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-data me-1"></i> Shipping Fee</a>
                    </li>
                  </ul>
                  <div class="card mb-4">
                    <h5 class="card-header">Shipping Fee</h5>
                    <hr class="my-0" />
                    <div class="card-body">
                      
                      <form id="formshippingSettings" method="POST" action="..\php\updateshippingfee0.php">
                        <div class="row">
                        <?php
                      ...
                      { ?>
                          <div class="mb-3 col-md-6">
                            <label for="<?php echo $row_rs['location'] ?>" class="form-label"><?php echo $row_rs['location'] ?> (RM)</label>
                            <input
                              class="form-control"
                              type="text"
                              id="<?php echo $row_rs['location']; ?>"
                              name="<?php echo $location ?>"
                              value="<?php echo number_format($row_rs['shipping_Subtotal'],2); ?>"
                            />
                          </div>
                          <?php
                          $location ="east";
                      ...
                      ?>
                          <div class="mt-2">
                            <button type="submit" class="btn btn-primary me-2" name="editship">Save changes</button>
                          </div>
                        </div>
                      </form>
                   </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      ?>
                          <div class="mt-2">
                            <button type="submit" class="btn btn-primary me-2" name="editprofile">Save changes</button>
                          </div>
                        </div>
                      </form>
                   </div>
