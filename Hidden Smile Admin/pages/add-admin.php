  ...
  <body>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <ul class="nav nav-pills">
                    <li class="nav-item">
                      <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-package me-1"></i>Admin</a>
                    </li>
                  </ul>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <?php
                        $total_rows = "SELECT COUNT(*) FROM admins";
                        $result = mysqli_query($dbconn,$total_rows);
                        $new_id = (mysqli_fetch_array($result)[0]) + 1;
                        ?>

                      <form id="formAddAdmin" name="formAddAdmin" method="POST" action="..\php\registerAdmin0.php">
                      <hr class="my-0 mb-4" />                  
                        <div class="row">
                          <div class="mb-3 col-md-6">
                            ...
                            <input
                              ...
                              id="admin"
                              name="admin"
                              placeholder="admin<?php echo $new_id?>"
                            />
                          </div>
                        ...
                        <div class="mt-2">
                          <button type="submit" class="btn btn-primary me-2" name="addadmin" onClick="return checkEmptyFields()">Register</button>
    ...
    <script>
      function checkEmptyFields(){
        var admin = document.formAddAdmin.admin.value;
        var password = document.formAddAdmin.password.value;
