...
>
  <head>
    ...
    <title>Tables - Users Tables</title>
    ...
    function del(uid){
      var cof=confirm("Are you sure you want to DEACTIVATE "+ uid +"?");
      if(cof==true){
    ...
    <script type="text/javascript">
    function view(uid){ 
        window.location ='../pages/view-user-details.php?uid=' + uid;
    }
    </script>
  </head>
                ...
                <form action="" method="post">
                  <table class="table table-striped">
                    ...
                    <?php
                      ...
                      $sql="SELECT* FROM customers LIMIT $start_from,$per_page_record";
                      ...
                      <tr>
                        ...
                        <td> <strong><?php echo $row_rs['cust_ID']; ?></strong></td>
                        <td><?php echo $row_rs['cust_Name']; ?></td>
                        <td>
                        <?php echo $row_rs['cust_Email']; ?>
                        </td>
                        <td><?php echo $row_rs['cust_PhoneNo']; ?></td>
                        <?php if($row_rs['acc_Status'] == 'Inactive'){ ?>
                        <td>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a type="button" class="dropdown-item" href="javascript:void(0);" onClick="view('<?php echo $row_rs['cust_ID'];?>')"
                                ><i class="bx bx-show me-1"></i> View</a>
                              <?php if($row_rs['acc_Status'] != 'Inactive'){ ?>
                              <a type="button" class="dropdown-item" href="javascript:void(0);" onClick="del('<?php echo $row_rs['cust_ID'];?>')"><i class="bx bx-user-x me-1" ></i>Deactivate</a>
                              <?php } 
                              else {?>
                              <a type="button" class="dropdown-item" href="javascript:void(0);" onClick="acc('<?php echo $row_rs['cust_ID'];?>')"><i class="bx bx-user-check me-1" ></i>Activate</a>
                              <?php } ?>
                            </div>
                          </div>
                        </td>
          ...
          <div class="layout-page">
            ...
            <div class="content-wrapper">
              ...
              <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <!-- Striped Rows -->
                <div class="card">
                  <h5 class="card-header">Users Accounts</h5>
                  <div class="table-responsive text-nowrap">
                  <form action="" method="post">
                    <table class="table table-striped">
                      <thead>
